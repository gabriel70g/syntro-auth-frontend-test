...
const SECURITY_FEATURES = [
    ...
    { name: 'Argon2id', desc: 'Hashing configurable (16/32/64MB) con versionado automático. Cada hash recuerda sus parámetros originales; migración gradual sin re-encriptar. El móvil solo cifra con RSA, sin carga pesada.' },
